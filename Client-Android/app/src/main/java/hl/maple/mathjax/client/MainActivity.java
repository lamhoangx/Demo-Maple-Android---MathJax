...
public class MainActivity extends Activity {
	...
	public static String strDataReceive;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		intent = new Intent(this, Views.class);
	...
	public class connectTask extends AsyncTask<String, String, Client> {
		...
		protected void onProgressUpdate(String... values) {
			...
			mAdapter.notifyDataSetChanged();
			// if (!Client.serverMessage.equals("")
			// && Client.serverMessage != null) {
			// // Intent i = new Intent(getBaseContext(), Views.class);
			// intent.putExtra("query", Client.serverMessage);
			// startActivity(intent);
			// System.out.println("START ACTIVITY INTENT");
			// strDataReceive = "";
			// }
		}
	}
